...
`ComplexityAnalysis.Analyzers` usa a configuracao padrao de severidade de diagnostics Roslyn. A Phase 4 nao define opcoes customizadas do analyzer.
...
A Phase 4 nao expoe opcoes para:
