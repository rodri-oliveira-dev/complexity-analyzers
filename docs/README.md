...
- [Português (Brasil)](pt-BR/getting-started.md)
...
- [Primeiros Passos](pt-BR/getting-started.md)
...
The repository-level overview is available in [README.md](../README.md) and [README.pt-BR.md](../README.pt-BR.md).
