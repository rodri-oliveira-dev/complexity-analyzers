...
internal static class DiagnosticPropertyNames
{
    ...
    internal const string CombinedComplexity = "combinedComplexity";
    internal const string RecurrenceClass = "recurrenceClass";
    internal const string DiagnosticRole = "diagnosticRole";
}
